...
export default class ExpenseEntries extends React.Component {
  constructor(props) {
    ...
    // Here we're binding these methods to the context of the components. This
    // only has to be done, because these methods are called back by event
    // emitters (which lose context).
